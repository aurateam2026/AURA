...
from vllm.model_executor.models.interfaces import supports_mm_encoder_only
    ...
    # For newer vllm versions where supports_mm_encoder_only is removed
    def supports_mm_encoder_only(model):
        return getattr(model, "supports_mm_encoder_only", False)
