...
class OpenAIAPIWrapper(BaseAPIWrapper):
    def __init__(self, caller_name="default", api_base="",  key_pool=[], temperature=0, model="gpt-4o-2024-08-06", time_out=5):
        api_base = API_BASE
        key_pool = [API_KEY]
        # print(api_base)
        # print(key_pool)
    ...
    def request(self, usr_question, system_content, video_path=None):
        ...
        print(total_frames)
        num_frames = min(total_frames, 128)
    ...
    def process_video(self, video_path, seconds_per_frame=1):
        base64Frames = []
        ...
        while curr_frame < total_frames - 1:
            ...
            if not success:
                print("Encounter Error while loading video.")
                break
