...
from .rmt_mlp_transformer_projector import RMTMLPTransformerProjector
...
def build_vision_projector(config, delay_load=False, **kwargs):
    ...
    if projector_type == 'identity':
        ...
        pass # TODO
    elif 'rmt_mlp_transformer' in projector_type:
        rmt_mlp_transformer_layer = re.match(r'^rmt_mlp_transformer(\d+)x', projector_type)
        rmt_mlp_transformer_depth = int(rmt_mlp_transformer_layer.group(1))
        return RMTMLPTransformerProjector(config, rmt_mlp_transformer_depth)
