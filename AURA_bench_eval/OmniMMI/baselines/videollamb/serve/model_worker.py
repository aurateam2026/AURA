...
from llava.constants import IDEFAULT_X_START_TOKEN, DEFAULT_X_TOKEN, DEFAULT_X_END_TOKEN, X_TOKEN_INDEX
...
class ModelWorker:
    def __init__(self, controller_addr, worker_addr,
                 ...
                 model_path, model_base, model_name, num_frames,
        ...
        self.tokenizer, self.model, self.processor, self.context_len = load_pretrained_model(
            model_path, model_base, self.model_name, num_frames, load_8bit, load_4bit, device=self.device, use_flash_attn=use_flash_attn)
