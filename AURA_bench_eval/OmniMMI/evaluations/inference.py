...
def load_model(TESTING_MODEL, device, ckpt_path_override=None):
    ...
    elif TESTING_MODEL == "qwen3vl-8b-online":
        from QWen3VL_online import EvalQWen3VL_online
        ckpt_path = ckpt_path_override
        model = EvalQWen3VL_online({"model_path": ckpt_path, "device": 0})
...
def main():
    ...
    parser.add_argument("--model_name", type=str,
                    ...
                    choices=["VideoChatGPT", "VideoChat2", "VideoLLaVA", "LLaMA-VID","MiniGPT4-Video", "PLLaVA", "LLaVA-NeXT-Video", "ShareGPT4Video",
                                 ...
                                 "VideoLLaMA2", "M4-Audio", "M4-AudioOnline", "qwen3vl-8b-online"], required=True)
    ...
    parser.add_argument("--ckpt_path", type=str, default=None, help='Override checkpoint / model path.')

    args = parser.parse_args()
    
    model = load_model(args.model_name, args.device, ckpt_path_override=args.ckpt_path)
